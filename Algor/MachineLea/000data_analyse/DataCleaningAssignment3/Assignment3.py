...
# then create a dateframe that displays the sample size (the number
# of countries in each continent bin), and the sum, mean, and std deviation for the estimated population of each country.
#
# ```python
